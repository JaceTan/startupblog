<div class="blogPosts index">
	<h2><?php echo __('Admin Blog Posts'); ?></h2>
	...
	<tr>
		...
		<td><?php echo h($blogPost['BlogPost']['created_by']); ?>&nbsp;</td>
		<td><?php echo h($blogPost['BlogPost']['modified_by']); ?>&nbsp;</td>
		<td class="actions">
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('New Blog Post'), array('plugin'=> 'startup_blog', 'admin' => true, 'action' => 'add')); ?></li>
	</ul>
</div>
